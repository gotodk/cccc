<%@ Page Title="" Language="C#" MasterPageFile="~/adminht/MasterPageMain.master" AutoEventWireup="true" CodeFile="edit_myinfo.aspx.cs" Inherits="bas_dangan_edit_myinfo" %>
    ...
    <uc1:wuc_script runat="server" ID="wuc_script" />
        ...
        <script type="text/javascript">
            jQuery(function ($) {
                ...
                if (getUrlParam("my") == "my") {

                    location.href = "/adminht/corepage/dangan/edit_myinfo.aspx?idforedit=<%=UserSession.唯一键%>&fff=1";
                }

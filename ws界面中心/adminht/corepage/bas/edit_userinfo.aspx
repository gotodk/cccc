<%@ Page Title="" Language="C#" MasterPageFile="~/adminht/MasterPageMain.master" AutoEventWireup="true" CodeFile="edit_userinfo.aspx.cs" Inherits="bas_edit_userinfo" %>
                    ...
                    if ($(dfx_str).text() != oldzhi) {
                        ...
                        if (arr != null) {//如果能匹配成功即arr数组不为空，循环输出结果
                            for (var i = 0; i < arr.length; i++) {
                                ...
                                if (arr_z[0] == "[名称")
                                { $("#suoshuquyu_show").val($.trim(arr_z[1]).replace("]", "")); }
